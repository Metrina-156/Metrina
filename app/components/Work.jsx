...
const Work = () => {
  const projects = [
    ...
    { id: 3, title: "Artesenal henna", year: "2026", tag: "E-Commerce", desc: "A fully responsive e-commerce platform designed for a henna brand, featuring product listings, a shopping cart, and a seamless checkout experience. Built with a warm, earthy aesthetic that reflects the artistry and cultural richness of henna. Focused on intuitive UX to convert browsers into buyers.", img: "https://res.cloudinary.com/dlauksjfq/image/upload/v1779603043/Screenshot_2026-05-24_112759_ctbcag.png", link: "#" }
  ];
